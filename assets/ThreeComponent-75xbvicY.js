import{i as e,n as t,t as n}from"./jsx-runtime-BnxRlLMJ.js";import{B as r,H as i,J as a,K as o,R as s,S as c,U as l,W as u,Z as d,at as f,b as p,bt as m,c as h,i as g,ot as _,p as v,q as y,r as b,s as x,vt as S}from"./three.module-BLQJ8aAc.js";import{o as C,s as w}from"./index-CY0yBrBU.js";var T=e(t(),1),E=`// From three.js: position, uv, normal, time, etc.\r
\r
varying vec2 vUv;\r
\r
void main() {\r
...
`,O=1024,k=class{constructor(e){this.baseScene=e,this.scene=new f,this.camera=new l(-1,1,1,-1,.1,10),this.camera.position.set(0,0,1),this.camera.lookAt(0,0,0);let t=new Float32Array(O*O*4);for(let e=0;e<O;e++)for(let n=0;n<O;n++){let r=e*O+n,i=Math.random()*Math.PI*2,a=.3+.7*Math.random();t[r*4+0]=a*Math.cos(i),t[r*4+1]=a*Math.sin(i),t[r*4+2]=Math.random()*.1-.05,t[r*4+3]=-.5}this.initialPositionsTexture=new v(t,O,O,d,p),this.initialPositionsTexture.minFilter=i,this.initialPositionsTexture.magFilter=i,this.initialPositionsTexture.needsUpdate=!0,this.shaderMaterial=new _({uniforms:{uPositionObjects:{value:this.baseScene.objects.map(e=>e.position)},uPosition0:{value:this.initialPositionsTexture},uPosition1:{value:this.initialPositionsTexture},uPosition2:{value:this.initialPositionsTexture},time:{value:0}},vertexShader:E,fragmentShader:D});let n=new s(new o(2,2),this.shaderMaterial);this.scene.add(n),this.fbos=[];for(let e=0;e<3;e++){let e=this.createRenderTarget();this.fbos.push(e),this.baseScene.renderer.setRenderTarget(e),this.baseScene.renderer.render(this.scene,this.camera)}this.currentFboIndex=0,this.baseScene.renderer.setRenderTarget(null)}createRenderTarget(){return new m(O,O,{minFilter:i,magFilter:i,format:d,type:p})}debugArray(){let e=new Float32Array(O*O*4);return this.baseScene.renderer.readRenderTargetPixels(this.fbos[0],0,0,O,O,e),[...e.filter((e,t)=>t%4==3)].sort(()=>Math.random()-.5).slice(0,20).sort((e,t)=>e-t)}step(e){let[t,n,r]=[this.currentFboIndex,(this.currentFboIndex+1)%3,(this.currentFboIndex+2)%3];this.shaderMaterial.uniforms.uPosition1.value=this.fbos[r].texture,this.shaderMaterial.uniforms.uPosition2.value=this.fbos[t].texture,e.setRenderTarget(this.fbos[n]),e.render(this.scene,this.camera),e.setRenderTarget(null),this.currentFboIndex=n}setObjectPositions(){for(let e=0;e<5;e++)this.shaderMaterial.uniforms.uPositionObjects.value[e]=this.baseScene.objects[e].position}},A=`uniform sampler2D particleMap;\r
