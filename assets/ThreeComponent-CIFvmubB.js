var w=Object.defineProperty;var T=(i,e,t)=>e in i?w(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var n=(i,e,t)=>T(i,typeof e!="symbol"?e+"":e,t);import{r as p,j}from"./index-D-kvncAu.js";import{l as P,p as O,q as R,r as g,s as b,N as u,t as F,V as m,u as A,f as I,v as y,W as U,m as x,I as M,w as C,n as k,A as _,B as z,x as S,e as E,O as D}from"./OrbitControls-DV_4SOBH.js";const B=`// From three.js: position, uv, normal, time, etc.\r
\r
varying vec2 vUv;\r
...
\r
float encodeIntAndFloat(int i, float f) {\r
    return (float(i)+1.0)/10.0;\r
}\r
\r
void decodeIntAndFloat(float encoded, out int i, out float f) {\r
    i = int(round(10.0*encoded-1.0));\r
    f = 0.0;\r
}\r
\r
...
`,v=5,r=1024;class H{constructor(e){n(this,"baseScene");n(this,"scene");n(this,"camera");n(this,"material");n(this,"initialPositionsTexture");n(this,"fbos");n(this,"currentFboIndex");this.baseScene=e,this.scene=new P,this.camera=new O(-1,1,1,-1,.1,10),this.camera.position.set(0,0,1),this.camera.lookAt(0,0,0);const t=new Float32Array(r*r*4);for(let o=0;o<r;o++)for(let a=0;a<r;a++){let d=o*r+a,c=Math.random()*Math.PI*2,l=.3+.7*Math.random();t[d*4+0]=l*Math.cos(c),t[d*4+1]=l*Math.sin(c),t[d*4+2]=Math.random()*.1-.05,t[d*4+3]=-.5,t[d*4+3]=0}this.initialPositionsTexture=new R(t,r,r,g,b),this.initialPositionsTexture.minFilter=u,this.initialPositionsTexture.magFilter=u,this.initialPositionsTexture.needsUpdate=!0,this.material=new F({uniforms:{uPositionObjects:{value:Array.from({length:v},()=>new m(0,0,0))},uPosition0:{value:this.initialPositionsTexture},uPosition1:{value:this.initialPositionsTexture},uPosition2:{value:this.initialPositionsTexture},time:{value:0}},vertexShader:B,fragmentShader:N}),this.setObjectPositions();const s=new A(2,2),h=new I(s,this.material);this.scene.add(h),this.fbos=[];for(let o=0;o<3;o++){const a=this.createRenderTarget();this.fbos.push(a),this.baseScene.renderer.setRenderTarget(a),this.baseScene.renderer.render(this.scene,this.camera)}this.currentFboIndex=2,this.baseScene.renderer.setRenderTarget(null)}createRenderTarget(){return new y(r,r,{minFilter:u,magFilter:u,format:g,type:b})}step(e){const[t,s,h]=[this.currentFboIndex,(this.currentFboIndex+1)%3,(this.currentFboIndex+2)%3];this.material.uniforms.uPosition1.value=this.fbos[h].texture,this.material.uniforms.uPosition2.value=this.fbos[t].texture,e.setRenderTarget(this.fbos[s]),e.render(this.scene,this.camera),e.setRenderTarget(null),this.currentFboIndex=s}setObjectPositions(){for(let e=0;e<v;e++)this.material.uniforms.uPositionObjects.value[e]=this.baseScene.objects[e].position}}const V=`// From three.js: position, uv, normal\r
\r
