var D=Object.defineProperty;var R=(c,e,n)=>e in c?D(c,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):c[e]=n;var o=(c,e,n)=>R(c,typeof e!="symbol"?e+"":e,n);import{S as A,e as O,f as I,a as f,g as B,h as E,i as U,N as h,R as v,F as g,D as S,W as j,P as b,k as C,b as _,A as z,B as w,m as F,n as T,O as k,r as x,j as N,T as y}from"./index-BsFKOsBw.js";const L=`// From three.js: position, uv, normal, time, etc.\r
\r
varying vec2 vUv;\r
\r
void main() {\r
...
`,m=16,i=128,H=(c,e)=>{const n=20*Math.PI/180,t=62*Math.PI/180,r=5,a=c-n,d=e-t,s=r*a*Math.cos(t),l=r*d;return[s,l]};class W{constructor(e){o(this,"baseScene");o(this,"scene");o(this,"camera");o(this,"shaderMaterial");o(this,"initialPositionsTexture");o(this,"initialExtraDataTexture");o(this,"fbos");o(this,"currentFboIndex");this.baseScene=e,this.scene=new A,this.camera=new O(-1,1,1,-1,.1,10),this.camera.position.set(0,0,1),this.camera.lookAt(0,0,0),this.computeInitialTextures(),this.shaderMaterial=new I({uniforms:{uPositionObjects:{value:Array.from({length:m},()=>new f(-100,0,0))},extraData:{value:this.initialExtraDataTexture},uPosition0:{value:this.initialPositionsTexture},uPosition1:{value:this.initialPositionsTexture},uPosition2:{value:this.initialPositionsTexture},time:{value:0}},vertexShader:L,fragmentShader:G});const n=new B(2,2),t=new E(n,this.shaderMaterial);this.scene.add(t),this.fbos=[];for(let r=0;r<3;r++){const a=this.createRenderTarget();this.fbos.push(a),this.baseScene.renderer.setRenderTarget(a),this.baseScene.renderer.render(this.scene,this.camera)}this.currentFboIndex=0,this.baseScene.renderer.setRenderTarget(null)}createRenderTarget(){return new U(i,i,{minFilter:h,magFilter:h,format:v,type:g})}debugArray(){const e=new Float32Array(i*i*4);return this.baseScene.renderer.readRenderTargetPixels(this.fbos[0],0,0,i,i,e),[...e.filter((n,t)=>t%4==3)].sort(()=>Math.random()-.5).slice(0,20).sort((n,t)=>n-t)}step(e){const[n,t,r]=[this.currentFboIndex,(this.currentFboIndex+1)%3,(this.currentFboIndex+2)%3];this.shaderMaterial.uniforms.uPosition1.value=this.fbos[r].texture,this.shaderMaterial.uniforms.uPosition2.value=this.fbos[n].texture,e.setRenderTarget(this.fbos[t]),e.render(this.scene,this.camera),e.setRenderTarget(null),this.currentFboIndex=t}setObjectPositions(){for(let e=0;e<m;e++)this.shaderMaterial.uniforms.uPositionObjects.value[e]=new f(this.baseScene.appIconPositions[3*e+0],this.baseScene.appIconPositions[3*e+1],this.baseScene.appIconPositions[3*e+2])}computeInitialTextures(){const e=new Float32Array(i*i*4),n=new Float32Array(i*i*4);for(let a=0;a<i;a++)for(let d=0;d<i;d++){let s=a*i+d,l=Math.random()*Math.PI*2,p=.3+.7*Math.random();e[s*4+0]=1e3+p*Math.cos(l),e[s*4+1]=p*Math.sin(l),e[s*4+2]=0,e[s*4+3]=-.5,n[s*4+0]=0,n[s*4+1]=0,n[s*4+2]=0,n[s*4+3]=0}console.log(this.baseScene.data.scandinavia.pointsObj);let t=0,r=0;for(const a in this.baseScene.data.scandinavia.pointsObj){const d=this.baseScene.data.scandinavia.pointsObj[a];console.log("country, points",a,d);for(const s of d){const l=H(s[0]*Math.PI/180,s[1]*Math.PI/180),p=Math.floor(Math.random()*22);if(e[t*4+0]=l[0],e[t*4+1]=l[1],e[t*4+2]=0,n[t*4+0]=r,n[t*4+1]=p,n[t*4+2]=0,n[t*4+3]=0,t++,t>=i*i)throw Error("Particle texture size is too small.")}r++}console.log("index",t,`${(100*t/(i*i)).toFixed(1)}% of particles used`),this.initialPositionsTexture=new S(e,i,i,v,g),this.initialPositionsTexture.minFilter=h,this.initialPositionsTexture.magFilter=h,this.initialPositionsTexture.needsUpdate=!0,this.initialExtraDataTexture=new S(n,i,i,v,g),this.initialExtraDataTexture.minFilter=h,this.initialExtraDataTexture.magFilter=h,this.initialExtraDataTexture.needsUpdate=!0}}const q=`uniform sampler2D particleMap;\r
