var F=Object.defineProperty;var z=(s,e,r)=>e in s?F(s,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[e]=r;var n=(s,e,r)=>z(s,typeof e!="symbol"?e+"":e,r);import{r as x,j as k}from"./index-COOaPPKK.js";import{l as T,O as f,p as A,q as m,r as g,N as h,s as b,t as P,f as M,u as R,R as w,W as D,B as q,w as I,x as S,e as C,i as y}from"./three.module-BxuQ6Me3.js";const E=`varying vec2 vUv;\r
\r
void main() {\r
    vUv = uv;\r
...
}`,i=512;class U{constructor(e){n(this,"baseScene");n(this,"scene");n(this,"camera");n(this,"shaderMaterial");n(this,"initialPositionsTexture");n(this,"fbos");n(this,"currentFboIndex");this.baseScene=e,this.scene=new T,this.camera=new f(-1,1,1,-1,.1,10),this.camera.position.set(0,0,1),this.camera.lookAt(0,0,0);const r=new Float32Array(i*i*4);for(let o=0;o<i;o++)for(let l=0;l<i;l++){let u=o*i+l,v=Math.random()*Math.PI*2,a=.3+.7*Math.random();r[u*4+0]=a*Math.cos(v),r[u*4+1]=a*Math.sin(v),r[u*4+2]=Math.random()*2*Math.PI,r[u*4+3]=.5}this.initialPositionsTexture=new A(r,i,i,m,g),this.initialPositionsTexture.minFilter=h,this.initialPositionsTexture.magFilter=h,this.initialPositionsTexture.needsUpdate=!0,this.shaderMaterial=new b({uniforms:{uPosition:{value:this.initialPositionsTexture},trailMap:{value:this.baseScene.fbos[0].texture},resolution:{value:this.baseScene.getResolution()},time:{value:0}},vertexShader:E,fragmentShader:_});const t=new P(2,2),c=new M(t,this.shaderMaterial);this.scene.add(c),this.fbos=[];for(let o=0;o<2;o++){const l=this.createRenderTarget();this.fbos.push(l),this.baseScene.renderer.setRenderTarget(l),this.baseScene.renderer.render(this.scene,this.camera)}this.currentFboIndex=0,this.baseScene.renderer.setRenderTarget(null)}createRenderTarget(){return new R(i,i,{minFilter:h,magFilter:h,wrapS:w,wrapT:w,format:m,type:g})}step(e){const[r,t]=[this.currentFboIndex,(this.currentFboIndex+1)%2];this.shaderMaterial.uniforms.uPosition.value=this.fbos[r].texture,e.setRenderTarget(this.fbos[t]),e.render(this.scene,this.camera),e.setRenderTarget(null),this.currentFboIndex=t}}const W=`// From three.js: position, uv, normal\r
\r
...
`,j=`varying vec4 vPosition;\r
\r
void main() {\r
    vPosition = vec4(position.xy, 0., 1.);\r
    gl_Position = vPosition;\r
}`,B=`uniform sampler2D trailMap;\r
