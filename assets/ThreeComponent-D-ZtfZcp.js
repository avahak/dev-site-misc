var I=Object.defineProperty;var T=(i,e,t)=>e in i?I(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var n=(i,e,t)=>T(i,typeof e!="symbol"?e+"":e,t);import{r as p,j as O}from"./index-xi0T62Dv.js";import{l as P,p as j,q as R,r as g,s as b,N as m,t as F,V as u,u as A,f as w,v as y,W as U,m as x,I as M,w as k,n as C,A as E,B as z,x as S,e as D,O as _}from"./OrbitControls-DV_4SOBH.js";const N=`// From three.js: position, uv, normal, time, etc.\r
\r
varying vec2 vUv;\r
...
void decodeIntAndFloat(float encoded, out int i, out float f) {\r
    ...
    f = clamp(tan(PI*(t-0.5)), 0.5, 0.5);\r
    // f = fract(encoded);\r
}\r
\r
// float encodeIntAndFloat(int i, float f) {\r
