import{i as e,n as t,t as n}from"./jsx-runtime-BnxRlLMJ.js";import{t as r}from"./Box-CFEfsCq7.js";import{a as i,i as a,r as o,t as s}from"./index-D0dUgemU.js";import{Bt as c,Ft as l,Kt as u,Qt as d,U as f,Ur as p,Xt as m,Z as h,Zt as g,a as _,en as v,k as y,lr as b,m as x,nn as S,p as C,pn as w,qr as T,r as E,tn as D,ur as O}from"./three.module-B6HkQTe3.js";import{t as k}from"./lil-gui.module.min-DjGmwgKf.js";import{t as A}from"./OrbitControls-Dh6wquD6.js";var j=e(t(),1),M=`// From three.js: position, uv, normal, time, etc.\r
\r
out vec2 vUv;\r
\r
void main() {\r
...
`,P=1024,F=class{constructor(e){this.baseScene=e,this.scene=new b,this.camera=new g(-1,1,1,-1,.1,10),this.camera.position.set(0,0,1),this.camera.lookAt(0,0,0);let t=new Float32Array(P*P*4);for(let e=0;e<P;e++)for(let n=0;n<P;n++){let r=e*P+n,i=Math.random()*Math.PI*2,a=.3+.7*Math.random();t[r*4+0]=a*Math.cos(i),t[r*4+1]=a*Math.sin(i),t[r*4+2]=Math.random()*.1-.05,t[r*4+3]=-.5}this.initialPositionsTexture=new y(t,P,P,w,f),this.initialPositionsTexture.minFilter=u,this.initialPositionsTexture.magFilter=u,this.initialPositionsTexture.needsUpdate=!0,this.shaderMaterial=new O({uniforms:{uPositionObjects:{value:this.baseScene.objects.map(e=>e.position)},uPosition0:{value:this.initialPositionsTexture},uPosition1:{value:this.initialPositionsTexture},uPosition2:{value:this.initialPositionsTexture},time:{value:0}},vertexShader:M,fragmentShader:N});let n=new l(new v(2,2),this.shaderMaterial);this.scene.add(n),this.fbos=[];for(let e=0;e<3;e++){let e=this.createRenderTarget();this.fbos.push(e),this.baseScene.renderer.setRenderTarget(e),this.baseScene.renderer.render(this.scene,this.camera)}this.currentFboIndex=0,this.baseScene.renderer.setRenderTarget(null)}createRenderTarget(){return new T(P,P,{minFilter:u,magFilter:u,format:w,type:f})}debugArray(){let e=new Float32Array(P*P*4);return this.baseScene.renderer.readRenderTargetPixels(this.fbos[0],0,0,P,P,e),[...e.filter((e,t)=>t%4==3)].sort(()=>Math.random()-.5).slice(0,20).sort((e,t)=>e-t)}step(e){let[t,n,r]=[this.currentFboIndex,(this.currentFboIndex+1)%3,(this.currentFboIndex+2)%3];this.shaderMaterial.uniforms.uPosition1.value=this.fbos[r].texture,this.shaderMaterial.uniforms.uPosition2.value=this.fbos[t].texture,e.setRenderTarget(this.fbos[n]),e.render(this.scene,this.camera),e.setRenderTarget(null),this.currentFboIndex=n}setObjectPositions(){for(let e=0;e<5;e++)this.shaderMaterial.uniforms.uPositionObjects.value[e]=this.baseScene.objects[e].position}dispose(){this.initialPositionsTexture.dispose();for(let e=0;e<3;e++)this.fbos[e].dispose();this.shaderMaterial.dispose()}},I=`uniform sampler2D particleMap;\r
