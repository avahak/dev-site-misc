var V=Object.defineProperty;var z=(r,t,e)=>t in r?V(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var u=(r,t,e)=>z(r,typeof t!="symbol"?t+"":t,e);import{r as k,j as H}from"./index-Dr0TVRxQ.js";import{l as O,p as R,q as U,r as I,s as P,N as b,t as T,u as G,f as j,v as N,W as Y,m as L,I as J,w as X,V as y,n as W,A as K,B as Z,x as D,e as q,O as Q}from"./OrbitControls-DV_4SOBH.js";const tt=`// From three.js: position, uv, normal, time, etc.\r
\r
varying vec2 vUv;\r
...
`,B=5,c=1024;class it{constructor(t){u(this,"baseScene");u(this,"scene");u(this,"camera");u(this,"material");u(this,"initialPositionsTexture");u(this,"fbos");u(this,"currentFboIndex");this.baseScene=t,this.scene=new O,this.camera=new R(-1,1,1,-1,.1,10),this.camera.position.set(0,0,1),this.camera.lookAt(0,0,0);const e=new Float32Array(c*c*4);for(let o=0;o<c;o++)for(let s=0;s<c;s++){let p=o*c+s,l=Math.random()*Math.PI*2,d=.3+.7*Math.random();e[p*4+0]=d*Math.cos(l),e[p*4+1]=d*Math.sin(l),e[p*4+2]=Math.random()*.1-.05,e[p*4+3]=-.5}this.initialPositionsTexture=new U(e,c,c,I,P),this.initialPositionsTexture.minFilter=b,this.initialPositionsTexture.magFilter=b,this.initialPositionsTexture.needsUpdate=!0,this.material=new T({uniforms:{uPositionObjects:{value:this.baseScene.objects.map(o=>o.position)},uPosition0:{value:this.initialPositionsTexture},uPosition1:{value:this.initialPositionsTexture},uPosition2:{value:this.initialPositionsTexture},time:{value:0}},vertexShader:tt,fragmentShader:et});const i=new G(2,2),n=new j(i,this.material);this.scene.add(n),this.fbos=[];for(let o=0;o<3;o++){const s=this.createRenderTarget();this.fbos.push(s),this.baseScene.renderer.setRenderTarget(s),this.baseScene.renderer.render(this.scene,this.camera)}this.currentFboIndex=0,this.baseScene.renderer.setRenderTarget(null)}createRenderTarget(){return new N(c,c,{minFilter:b,magFilter:b,format:I,type:P})}debugArray(){const t=new Float32Array(c*c*4);return this.baseScene.renderer.readRenderTargetPixels(this.fbos[0],0,0,c,c,t),[...t.filter((e,i)=>i%4==3)].sort(()=>Math.random()-.5).slice(0,20).sort((e,i)=>e-i)}step(t){const[e,i,n]=[this.currentFboIndex,(this.currentFboIndex+1)%3,(this.currentFboIndex+2)%3];this.material.uniforms.uPosition1.value=this.fbos[n].texture,this.material.uniforms.uPosition2.value=this.fbos[e].texture,t.setRenderTarget(this.fbos[i]),t.render(this.scene,this.camera),t.setRenderTarget(null),this.currentFboIndex=i}setObjectPositions(){for(let t=0;t<B;t++)this.material.uniforms.uPositionObjects.value[t]=this.baseScene.objects[t].position}}const nt=`// From three.js: position, uv, normal\r
\r
...
void main() {\r
    ...
    if (dist > 0.5)\r
        discard;\r
\r
    float stateF = decodeFloat(vPosition.w);\r
